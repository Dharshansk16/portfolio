...
export default function BackgroundEffects({
 ...
 <>
 <div
 className="absolute top-0 left-0 w-[300px] h-[300px] bg-zinc-800 dark:bg-zinc-200 rounded-full"
 style={{ filter:"blur(60px)"}}
 />
 <div
 className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-zinc-800 dark:bg-zinc-200 rounded-full"
 style={{ filter:"blur(60px)"}}
 />
 </>
 ) : (
 <>
 <motion.div
 className="absolute top-0 left-0 w-[400px] h-[400px] bg-zinc-800 dark:bg-zinc-200 rounded-full blur-[80px]"
 ...
 />
 <motion.div
 className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-zinc-800 dark:bg-zinc-200 rounded-full blur-[80px]"
