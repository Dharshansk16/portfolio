...
export default function UIHints() {
 ...
 <h3 className="text-zinc-900 dark:text-white font-bold text-xs uppercase tracking-widest">
 Quick Actions
 </h3>
 <button
 ...
 >
 <span className="text-zinc-600 dark:text-zinc-400 text-sm font-medium group-hover:text-zinc-900 dark:group-hover:text-white transition-colors">
 {shortcut.description}
 </span>
 <kbd className="px-2.5 py-1 bg-zinc-100 dark:bg-zinc-900 rounded-md font-mono text-xs font-semibold text-zinc-900 dark:text-white border border-zinc-200 dark:border-zinc-800">
 {shortcut.key}
 </kbd>
 </div>
 ))}
