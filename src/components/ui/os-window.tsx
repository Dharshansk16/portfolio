...
export default function OSWindow({
 ...
 className={`bg-white dark:bg-black/95 backdrop-blur-3xl border border-zinc-200 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col ${className}`}
 style={{
 ...
 <div className="bg-zinc-100/80 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-white/10 px-4 py-2 md:py-2.5 flex items-center justify-between backdrop-blur-xl group flex-shrink-0">
 ...
 whileTap={{ scale: 0.95}}
 onClick={onClose}
 className="md:hidden flex items-center justify-center w-8 h-8 rounded-lg bg-zinc-100 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 hover:border-zinc-300 dark:border-zinc-700 text-zinc-500 hover:text-zinc-500 transition-all touch-manipulation"
 aria-label="Go back"
 >
 ...
 <button
 onClick={onClose}
 className="w-3 h-3 rounded-full bg-zinc-800 dark:bg-zinc-200 hover:bg-zinc-800 dark:bg-zinc-200 transition-colors touch-manipulation"
 style={{ boxShadow:"0 2px 4px rgba(239, 68, 68, 0.3)"}}
 aria-label="Close window"
 >
 <X className="w-2 h-2 text-zinc-500 absolute inset-0 m-auto opacity-0 group-hover:opacity-100 transition-opacity" />
 </button>
 <button
 onClick={onMinimize}
 className="w-3 h-3 rounded-full bg-zinc-800 dark:bg-zinc-200 hover:bg-zinc-800 dark:bg-zinc-200 transition-colors touch-manipulation"
 ...
 >
 <Minus className="w-2 h-2 text-zinc-500 absolute inset-0 m-auto opacity-0 group-hover:opacity-100 transition-opacity" />
 </button>
 <button
 ...
 >
 <Square className="w-2 h-2 text-zinc-500 absolute inset-0 m-auto opacity-0 group-hover:opacity-100 transition-opacity" />
 </button>
 </div>
 </>
 )}
 ...
 <h3
 className={`text-xs sm:text-sm font-semibold text-zinc-900 dark:text-zinc-100 drop-shadow-sm truncate`}
 >
 {title}
 </h3>
 {subtitle && (
