...
import TorchLight from "@/components/animations/torch-light";
...
export default function DevSpaceOS() {
  ...
  useEffect(() => {
    ...
    // Always play the boot screen on load as requested
                ...
                >
                  ...
                  <div id="projects">
                    <Suspense fallback={<AppLoader />}>
                      <ProjectsApp
                        isEmbedded
                        onViewAll={() => setCurrentApp("projects")}
                      />
                    </Suspense>
                  </div>
                  <div id="achievements">
                    <Suspense fallback={<AppLoader />}>
                      <AchievementsApp
                        isEmbedded
                        onViewAll={() => setCurrentApp("achievements")}
                      />
                    </Suspense>
                  </div>
                  <div id="blog">
